...
class ApiExceptions {
  static void procesarError(dynamic error, [bool showInDialog = true]) async {
    final String intentoConEmail =
        "\n\nIntente nuevamente en algunos segundos, si el error persiste envíenos un email a ${Constants.kEmailSoporte}";
        ...
        if (error is DioError) {
          switch (error.type) {
            ...
            case DioErrorType.receiveTimeout:
              _networkExceptions = "Error de tiempo de espera del servidor! $intentoConEmail";
              break;
              ...
              if (_networkExceptions == '') {
                switch (error.response?.statusCode) {
                  ...
                  case 403:
                    ...
                    break;
                  case 404:
                    _networkExceptions = "Recurso no encontrado! $intentoConEmail";
                    break;
                  case 409:
                    _networkExceptions = "Error de conflicto! $intentoConEmail";
                    break;
                  case 408:
                    _networkExceptions = "Error de tiempo de espera del servidor! $intentoConEmail";
                    break;
                  ...
                  default:
                    ...
                    _networkExceptions = "Código de error inválido ($responseCode)! $intentoConEmail";
                }
              }
              break;
    ...
    if (showInDialog) {
      await Get.dialog(
        AlertDialog(
          ...
          content: Text(_networkExceptions,
              style: const TextStyle(color: kTAllLabelsColor)),
          actions: lActions,
        ),
